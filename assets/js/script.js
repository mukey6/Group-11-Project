...
let searchInput=$("#search-input").val()  
    ...
    var apiRecipe = "https://api.edamam.com/api/recipes/v2?type=public&q="+searchInput+"&app_id=a2a764d9&app_key=" + recipeApiKey
    ...
    var imageApi = "https://api.unsplash.com/search/photos?page=1&query="+searchInput+"&client_id=" + imageApiKey
